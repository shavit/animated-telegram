defmodule FootballResults.Schema.Types do
  ...
  object :team_node do
    ...
    field(:loses, non_null(:integer), description: "Overall number of loses")
    field(:wins, non_null(:integer), description: "Overall number of wins")
    field(:meetings, list_of(:meeting_result), description: "Meeting results")
  end
  ...
  defp resolve_team_away(parent, _args, _resolution) do
    case parent do
  ...
  defp resolve_team_home(parent, _args, _resolution) do
    case parent do
